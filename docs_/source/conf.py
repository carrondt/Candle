...
latex_documents = [
    (master_doc, 'test_candle.tex', 'test\\_candle Documentation',
     'dc', 'manual'),
]
...
man_pages = [
    (master_doc, 'test_candle', 'test_candle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'test_candle', 'test_candle Documentation',
     author, 'test_candle', 'One line description of project.',
     'Miscellaneous'),
]
